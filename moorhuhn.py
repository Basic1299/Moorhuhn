import pygame, sys, random, csv, os
...
class Chicken(pygame.sprite.Sprite):
    def __init__(self, pos_y):
        super().__init__()
        # Images
        self.chicken_right_surf = [pygame.image.load(f"images/chicken_fly_right/chicken_fly_right{x}.png").convert_alpha() for x in range(7)]
        self.chicken_left_surf = [pygame.image.load(f"images/chicken_fly_left/chicken_fly_left{x}.png").convert_alpha() for x in range(7)]
        self.chicken_dead_surf = [pygame.image.load(f"images/chicken_dead/chicken_dead{x}.png").convert_alpha() for x in range(2)]
